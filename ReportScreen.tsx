      ...
      <div className="mx-5 mb-4 grid grid-cols-2 gap-3">
        <div className="rounded-xl bg-card border border-border p-3">
          ...
          <div className="h-20 w-full overflow-hidden rounded-lg mb-2">
            <img src={CHARACTERS["F_A"].src} alt="" className="h-full w-full object-cover object-top" />
          </div>
        ...
        <div className="rounded-xl bg-card border border-border p-3">
          ...
          <div className="h-20 w-full overflow-hidden rounded-lg mb-2">
            <img src={CHARACTERS["M_A"].src} alt="" className="h-full w-full object-cover object-top" />
          </div>
