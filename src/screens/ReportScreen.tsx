...
const GROWTH_ID: CharacterId = "M_A";
        ...
        <div className="rounded-xl bg-card border border-border p-3">
          ...
          {RANKING.map((r) => (
            <div key={r.name} className="flex items-center gap-2 mb-1.5">
              <span className="text-sm w-4 text-center">{RANKING_MEDALS[r.rank - 1] ?? r.rank}</span>
      ...
      <div className="mx-5 mb-4 grid grid-cols-2 gap-3">
        <div className="rounded-xl bg-card border border-border p-3">
          ...
          <div className="h-20 w-full overflow-hidden rounded-lg mb-2">
            <img src={CHARACTERS[BEST_ID].src} alt="" className="h-full w-full object-cover object-top" />
          </div>
        ...
        <div className="rounded-xl bg-card border border-border p-3">
          ...
          <div className="h-20 w-full overflow-hidden rounded-lg mb-2">
            <img src={CHARACTERS[GROWTH_ID].src} alt="" className="h-full w-full object-cover object-top" />
          </div>
