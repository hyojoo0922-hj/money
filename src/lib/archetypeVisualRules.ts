...
export const ARCHETYPE_VISUAL_RULES: Record<string, ArchetypeVisualRule> = {
  reply_overthinker: {
    ...
    outfit:         "oversized dark navy or deep purple hoodie, casual shorts, indoor socks — disheveled but cozy, the look of someone who hasn't left the room",
  ...
  emotion_locomotive: {
    ...
    accessories:    "headphones around neck (not in ears — too busy feeling), small charm or meaningful pin on jacket, hair loose or wind-blown from the emotional intensity",
    background:     "swirling soft abstract emotion waves behind them, warm gradient atmosphere, small floating symbols of passion — flame, heartbeat line, music notes — rendered softly",
  ...
  relationship_weather_caster: {
    ...
    background:     "soft sky gradient behind with mixed weather symbols — sun, clouds, gentle rain — rendered as soft floating icons, emotional weather map suggested in background",
